...
class ChromaApiV2Impl {
    ...
    public void createTenant(Tenant tenant) throws IOException, InterruptedException {
        httpClient.post("api/v2/tenants", tenant, Void.class);
    }

    public Tenant tenant(String tenantName) throws IOException, InterruptedException {
        Map<String, String> pathParams = new HashMap<>();
        pathParams.put("tenant_name", tenantName);
        return httpClient.get("api/v2/tenants/{tenant_name}", Tenant.class, pathParams);
    }

    public void createDatabase(String tenantName, Database createDatabaseRequest)
    ...
    public Database database(String tenantName, String databaseName) throws IOException, InterruptedException {
        Map<String, String> pathParams = new HashMap<>();
        pathParams.put("tenant_name", tenantName);
    ...
    public Collection collection(String tenantName, String databaseName, String collectionName)
            throws IOException, InterruptedException {
        Map<String, String> pathParams = new HashMap<>();
        pathParams.put("tenant_name", tenantName);
        pathParams.put("database_name", databaseName);
