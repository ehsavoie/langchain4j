...
class JaxrsRestClientHttpClientIT extends AbstractOllamaLanguageModelInfrastructure {
    protected List<HttpClient> clients() {
        return List.of(new JaxrsRestClientHttpClientBuilder().build());
    }

    protected String getChatUrl() {
        return ollamaBaseUrl(ollama) + "/api/chat";
    }
                    ...
                    .body(
                            """
                            {
                                ...
                                "messages" : [
                                    {
                                        "role" : "system",
                                        "content" : "Translate messages from user into German"
                                    },
                                    {
                                        "role" : "user",
                                        "content" : "I love you"
